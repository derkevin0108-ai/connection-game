...
export default function Home() {
  ...
  // Wenn man via /join/XYZ kommt, soll Code-Feld vorausgefüllt sein
  useEffect(() => {
        ...
        <div className="grid grid-cols-6 gap-2">
          {EMOJIS.map((e) => (
            <button
              key={e}
              onClick={() => setEmoji(e)}
              className={`text-2xl py-2 rounded-lg ${
                emoji === e ? 'bg-indigo-500' : 'bg-slate-800'
              }`}
            >
              {e}
            </button>
        ...
        {codeFromUrl ? (
          ...
          <>
            ...
            <input
              ...
              placeholder="Raum-Code (4 Zeichen)"
              maxLength={4}
